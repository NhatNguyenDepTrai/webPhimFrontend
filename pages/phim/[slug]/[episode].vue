<template>
 <div>
  ...
  <Meta v-if="!pending && data.product" name="og:title" :content="'Xem phim ' + data.product.name + ' - ' + data.product.full_name + data.episode.name" />
  ...
  <Meta v-if="!pending && data.product" property="og:title" :content="'Xem phim ' + data.product.name + ' - ' + data.product.full_name + data.episode.name" />
